  ...
  //   $("#goBtn").click(function(event) {
	...
	// 	});
  //
  //   $("#stp-01").click(function(event) {
  //       var yes=step.goStep(1)
  //   });
  //     $("#stp-02").click(function(event) {
  //         var yes=step.goStep(2)
  //     });
  //     $("#stp-03").click(function(event) {
  //         var yes=step.goStep(3)
  //     });
  //     $("#stp-04").click(function(event) {
  //         var yes=step.goStep(4)
  //     });
  //     $("#stp-05").click(function(event) {
  //         var yes=step.goStep(5)
  //     });
  // });
