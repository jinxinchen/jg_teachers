...
function loadTeachingMaterials(){
    var saveUrl = "/teachers/admin/teachingUnknowMaterials/addMaterial.do";
    var deleteUrl = "/teachers/admin/teachingUnknowMaterials/deleteMaterial.do";
    var updateUrl = "/teachers/admin/teachingUnknowMaterials/editMaterial.do";
    var loadDataUrl = "/teachers/admin/teachingUnknowMaterials/loadMaterial.do";
