...
function loadTeachingMaterials(){
    var saveUrl = "/teachers/teachingArchives/addMaterial.do?status="+"学院";
    var deleteUrl = "/teachers/teachingArchives/deleteMaterial.do";
    var updateUrl = "/teachers/teachingArchives/editMaterial.do?status="+"学院";
    var loadDataUrl = "/teachers/teachingArchives/loadMaterial.do?status="+"学院";
