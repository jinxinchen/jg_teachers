 ...
 */
@Entity
@Table(name = "v_teachers_prize_check", schema = "jg_teachers", catalog = "")
public class VTeachersPrizeCheckEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        VTeachersPrizeCheckEntity that = (VTeachersPrizeCheckEntity) o;
