 ...
 */
@Entity
@Table(name = "v_admin_abilityproject", schema = "jg_teachers", catalog = "")
public class VAdminAbilityprojectEntity {
    private String name;
    private Integer id;
    ...
    public String toString() {
        return "VAdminAbilityprojectEntity{" +
                "name='" + name + '\'' +
                ", id=" + id +
                ", userId=" + userId +
                ", prizeId='" + prizeId + '\'' +
                ...
                ", unitOfPrizes='" + unitOfPrizes + '\'' +
                ", winner='" + winner + '\'' +
                ", winTime='" + winTime + '\'' +
                ", funds='" + funds + '\'' +
                ", fileName='" + fileName + '\'' +
                ", prizeEvidenceSrc='" + prizeEvidenceSrc + '\'' +
    ...
    public boolean equals(Object o) {
        ...
        VAdminAbilityprojectEntity that = (VAdminAbilityprojectEntity) o;
