...
public class TScientificEntity {
    ...
    public String toString() {
        return "TScientificEntity{" +
                ...
                ", scientificSource='" + scientificSource + '\'' +
                ", createTime='" + createTime + '\'' +
                ", endTime='" + endTime + '\'' +
                ", grants='" + grants + '\'' +
                ", createScientificEvidenceSrc='" + createScientificEvidenceSrc + '\'' +
                ", endScientificEvidenceSrc='" + endScientificEvidenceSrc + '\'' +
                ", status='" + status + '\'' +
                ", others='" + others + '\'' +
                ", type='" + type + '\'' +
                ", memberList='" + memberList + '\'' +
                ", isMarch='" + isMarch + '\'' +
                ", createUpdateTime='" + createUpdateTime + '\'' +
   ...
   // @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    @Basic
    @Column(name = "create_scientific_evidence_src",updatable = false)
    ...
    @Basic
    @Column(name = "end_scientific_evidence_src",updatable = false)
    ...
    @Basic
    @Column(name = "create_update_time",updatable = false)
    ...
    @Basic
    @Column(name = "end_update_time",updatable = false)
