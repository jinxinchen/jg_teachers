...
function loadTeachingMaterials(){
    var saveUrl = "/teachers/teachingArchives/addMaterial.do?status="+"科研";
    var deleteUrl = "/teachers/teachingArchives/deleteMaterial.do";
    var updateUrl = "/teachers/teachingArchives/editMaterial.do?status="+"科研";
    var loadDataUrl = "/teachers/teachingArchives/loadMaterial.do?status="+"科研";
